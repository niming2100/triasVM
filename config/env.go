...
const (
	ConfigPath          = "${GOPATH}/src/triasVM/config_test.yaml"
	EntityMatcherLocal  = "${GOPATH}/src/triasVM/local_entity_matchers.yaml"
	ConfigPathSingleOrg = "${GOPATH}/src/triasVM/config_e2e_single_org.yaml"
	ChannelID           = "defaultChannel"
	AdminUser           = "Admin"
	OrdererOrgName      = "OrdererOrg"
	PeerAddress         = "http://localhost:7050"
	ContractVersion     = "v0"
)
